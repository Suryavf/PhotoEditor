...
extern "C" void transformColorModel(uchar *h_R , uchar *h_G , uchar *h_B , 
    ...
    cudaMalloc(&d_C3, n * sizeof(float));
    cudaMalloc(&d_n ,     sizeof( int ));

    cudaMemcpy(d_R, h_R, n * sizeof(float), cudaMemcpyHostToDevice);
    cudaMemcpy(d_G, h_G, n * sizeof(float), cudaMemcpyHostToDevice);
    cudaMemcpy(d_B, h_B, n * sizeof(float), cudaMemcpyHostToDevice);
    cudaMemcpy(d_n, (int)n,  sizeof( int ), cudaMemcpyHostToDevice);
    ...
    cudaMemcpy(h_C1, d_C1, n * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_C2, d_C2, n * sizeof(float), cudaMemcpyDeviceToHost);
    cudaMemcpy(h_C3, d_C3, n * sizeof(float), cudaMemcpyDeviceToHost);
